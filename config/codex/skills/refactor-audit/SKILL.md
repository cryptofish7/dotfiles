...
1. Delegate to the `refactor` agent when available. For cross-package changes, use the best available Codex implementation path and keep the change grouped as one logical refactor.
