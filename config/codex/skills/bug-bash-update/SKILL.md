...
1. **Test in the browser.** Verification happens via browser automation tools (navigate, click, screenshot, read page). `forge test`, `cast`, `pnpm test`, and code review do NOT count. If browser automation isn't available, stop and tell the user.
