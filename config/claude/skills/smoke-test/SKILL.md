...
- **Fast** — No network calls unless the feature being tested requires it. If network is needed, note it in the stage description and ask the user whether to include it.
