...
Additionally, collect all AGENTS.md files (root, `docs/AGENTS.md`, `packages/*/AGENTS.md`, `~/.codex/AGENTS.md`) and any leftover CLAUDE.md files still used for migration, then audit them for:
